...
public final class Dops {
    ...
    public static final Dop SHL_INT_LIT8 = new Dop(224, 152, -1, Form22b.THE_ONE, true);
    public static final Dop SHR_INT_LIT8 = new Dop(225, 153, -1, Form22b.THE_ONE, true);
    public static final Dop USHR_INT_LIT8 = new Dop(Opcodes.USHR_INT_LIT8, 154, -1, Form22b.THE_ONE, true);
    public static final Dop INVOKE_POLYMORPHIC = new Dop(250, 250, Opcodes.INVOKE_POLYMORPHIC_RANGE, Form45cc.THE_ONE, false);
    public static final Dop INVOKE_POLYMORPHIC_RANGE = new Dop(Opcodes.INVOKE_POLYMORPHIC_RANGE, 250, -1, Form4rcc.THE_ONE, false);
    public static final Dop INVOKE_CUSTOM = new Dop(Opcodes.INVOKE_CUSTOM, Opcodes.INVOKE_CUSTOM, 253, Form35c.THE_ONE, false);
    public static final Dop INVOKE_CUSTOM_RANGE = new Dop(253, Opcodes.INVOKE_CUSTOM, -1, Form3rc.THE_ONE, false);
    public static final Dop CONST_METHOD_HANDLE = new Dop(254, 254, -1, Form21c.THE_ONE, true);
    public static final Dop CONST_METHOD_TYPE = new Dop(255, 255, -1, Form21c.THE_ONE, true);
