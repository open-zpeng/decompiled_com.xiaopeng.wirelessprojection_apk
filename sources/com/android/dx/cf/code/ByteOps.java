...
public class ByteOps {
    ...
    static {
        ...
        while (i < 2498) {
            int i2 = 16;
            int digit = (Character.digit(OPCODE_DETAILS.charAt(i), 16) << 4) | Character.digit(OPCODE_DETAILS.charAt(i + 1), 16);
            char charAt = OPCODE_DETAILS.charAt(i + 3);
            if (charAt == '-') {
                i2 = 1;
            } else if (charAt == 'I') {
                i2 = 13;
            ...
            if (OPCODE_DETAILS.charAt(i3 - 1) == ':') {
                while (true) {
                    char charAt2 = OPCODE_DETAILS.charAt(i3);
                    if (charAt2 == 'D') {
                        i2 |= 256;
                    } else if (charAt2 == 'F') {
                        i2 |= 64;
