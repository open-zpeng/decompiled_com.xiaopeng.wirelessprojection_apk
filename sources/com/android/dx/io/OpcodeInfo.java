...
public final class OpcodeInfo {
    ...
    public static final Info SHL_INT_LIT8 = new Info(224, "shl-int/lit8", InstructionCodec.FORMAT_22B, IndexType.NONE);
    public static final Info SHR_INT_LIT8 = new Info(225, "shr-int/lit8", InstructionCodec.FORMAT_22B, IndexType.NONE);
    ...
    public static final Info INVOKE_POLYMORPHIC = new Info(250, "invoke-polymorphic", InstructionCodec.FORMAT_45CC, IndexType.METHOD_AND_PROTO_REF);
    ...
    public static final Info INVOKE_CUSTOM_RANGE = new Info(253, "invoke-custom/range", InstructionCodec.FORMAT_3RC, IndexType.CALL_SITE_REF);
    public static final Info CONST_METHOD_HANDLE = new Info(254, "const-method-handle", InstructionCodec.FORMAT_21C, IndexType.METHOD_HANDLE_REF);
    public static final Info CONST_METHOD_TYPE = new Info(255, "const-method-type", InstructionCodec.FORMAT_21C, IndexType.PROTO_REF);
