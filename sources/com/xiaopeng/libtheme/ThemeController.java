...
public class ThemeController {
    ...
    public static final long DEFAULT_STATE_DELAY = SystemProperties.getLong("persist.sys.theme.settings.delay", (long) C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
    public static final long DEFAULT_STATE_TIMEOUT = SystemProperties.getLong("persist.sys.theme.settings.timeout", (long) C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
