        ...
        if (vuiScene == null) {
            ...
            if (VuiUtils.is3DApp(VuiSceneManager.instance().getmPackageName()) && vuiSceneListener3 != null && (vuiSceneListener3 instanceof IUnityVuiSceneListener)) {
                    ...
                    if (sceneInfo != null) {
                        ...
                        if (subSceneList != null) {
                            while (i < subSceneList.size()) {
                                ...
                                if (vuiElementById != null && (vuiSceneListener2 = VuiSceneManager.instance().getVuiSceneListener(str3)) != null) {
                ...
                if (sceneInfo2 != null) {
                    ...
                    LogUtils.logInfo(this.TAG, "subSceneIds:" + subSceneList2);
                    if (subSceneList2 != null) {
                        while (i < subSceneList2.size()) {
                            String str4 = subSceneList2.get(i);
                            VuiElement vuiElementById2 = ((VuiSceneBuildCache) VuiSceneCacheFactory.instance().getSceneCache(VuiSceneCacheFactory.CacheType.BUILD.getType())).getVuiElementById(str4, this.vuiElement.getId());
                            LogUtils.logInfo(this.TAG, "targetElement:" + vuiElementById2);
                            if (vuiElementById2 != null && (vuiSceneListener = VuiSceneManager.instance().getVuiSceneListener(str4)) != null) {
                ...
                LogUtils.logInfo(this.TAG, "Event:" + vuiSceneListener5);
