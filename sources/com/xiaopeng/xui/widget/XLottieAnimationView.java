...
public class XLottieAnimationView extends LottieAnimationView implements VuiView {
    protected XViewDelegate mXViewDelegate;

    public XLottieAnimationView(Context context) {
        super(context);
    }

    public XLottieAnimationView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mXViewDelegate = XViewDelegate.create(this, attributeSet);
        initVui(this, attributeSet);
    }

    public XLottieAnimationView(Context context, AttributeSet attributeSet, int i) {
