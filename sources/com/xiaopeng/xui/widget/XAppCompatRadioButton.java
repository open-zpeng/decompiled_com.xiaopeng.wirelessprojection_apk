...
public class XAppCompatRadioButton extends AppCompatRadioButton implements VuiView {
    ...
    public XAppCompatRadioButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mXViewDelegate.getThemeViewModel().addCallback(new ThemeViewModel.OnCallback() { // from class: com.xiaopeng.xui.widget.XAppCompatRadioButton.1
            @Override // com.xiaopeng.libtheme.ThemeViewModel.OnCallback
            public void onThemeChanged() {
                XAppCompatRadioButton xAppCompatRadioButton = XAppCompatRadioButton.this;
                xAppCompatRadioButton.setButtonDrawable(xAppCompatRadioButton.buttonDrawable);
            }
        });
    }
