...
public class XCompoundButton extends CompoundButton implements VuiView {
    ...
    public XCompoundButton(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (FlavorUtils.isV5()) {
            this.mXViewDelegate.getThemeViewModel().addCallback(new ThemeViewModel.OnCallback() { // from class: com.xiaopeng.xui.widget.XCompoundButton.1
                @Override // com.xiaopeng.libtheme.ThemeViewModel.OnCallback
                public void onThemeChanged() {
                    XCompoundButton xCompoundButton = XCompoundButton.this;
                    xCompoundButton.setButtonDrawable(xCompoundButton.buttonDrawable);
                }
            });
