...
public class SystemPropertyUtil {
    ...
    public static void setAiosWakeUpEnable(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_AIOS_WAKEUP, z ? "1" : SessionDescription.SUPPORTED_SDP_VERSION);
    }
    ...
    public static void setInCall(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_CALLING, z ? "1" : SessionDescription.SUPPORTED_SDP_VERSION);
    }
