...
class RemoteOperator {
    ...
    public Object call(Uri uri, boolean z, byte[] bArr, boolean z2) throws RemoteException {
    ...
    public synchronized void linkToDeath() {
        if (this.mDeathRecipient == null) {
            IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: com.xiaopeng.lib.apirouter.RemoteOperator.1
    ...
    public synchronized void unLinkToDeath(String str) {
        ...
        if (deathRecipient != null) {
            if (!this.mIBinder.unlinkToDeath(deathRecipient, 0)) {
