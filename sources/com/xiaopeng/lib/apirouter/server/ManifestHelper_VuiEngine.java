...
public class ManifestHelper_VuiEngine implements IManifestHelper {
    ...
    public HashMap<String, Pair<IBinder, String>> getMapping() {
        ...
        Pair<IBinder, String> pair2 = new Pair<>(new ApiRouterUnitySceneService_Stub(), ApiRouterUnitySceneService_Manifest.toJsonManifest());
        for (String str2 : ApiRouterUnitySceneService_Manifest.getKey()) {
            this.mapping.put(str2, pair2);
        }
        Pair<IBinder, String> pair3 = new Pair<>(new ApiRouterOverallService_Stub(), ApiRouterOverallService_Manifest.toJsonManifest());
        for (String str3 : ApiRouterOverallService_Manifest.getKey()) {
